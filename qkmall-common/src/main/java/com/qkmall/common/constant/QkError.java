...
package com.qkmall.common.constant;


import com.qkmall.common.ErrorSupport;
import com.qkmall.common.ModuleSupport;
 ...
 */
public enum QkError implements ErrorSupport {
    ...
    QkError(boolean system, ModuleSupport module, String code, String message) {
        this.system = system;
