...
public class GeneratorCode {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/code_item?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","admin")
        ...
        String filePath = projectPath + "/qkmall-generator/src/main/java";  //java下的文件路径
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("model")//实体类包名
                .parent("com.qkmall")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/qkmall-generator/src/main/resources/mapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
                .build();
        /**
         * 模板配置
         */
